      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full px-4 py-2 bg-textColor2 text-white font-bold rounded-md hover:bg-cyan-600 hoverEffect disabled:bg-darkBackground"
          >
        ...
        {rateId && (
          <div className="my-8">
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-2 mb-6 bg-textColor2/90 text-white rounded-md hover:bg-textColor2 disabled:bg-gray-400"
            >
