      ...
      <Container className="py-10 flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-2.5 lg:gap-5">
            <AddToCartButton
              product={product}
              className="bg-darkBackground/80 text-white px-3 hover:bg-darkBackground hoverEffect"
            />
          ...
          <div className="flex items-center flex-wrap gap-5">
            <div className="border border-darkBackground text-center hover:border-textColor2 rounded-md hoverEffect">
              <p className="text-base font-semibold text-darkBackground">
                Free Shipping
              </p>
              <p className="text-sm text-textColor1">
                Free shipping over order $200
              </p>
            </div>
            <div className="border border-darkBackground text-center hover:border-textColor2 rounded-md hoverEffect">
              <p className="text-base font-semibold text-darkBackground">
