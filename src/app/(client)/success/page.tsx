  ...
  return (
    <div className="py-10 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4 ">
        <motion.div initial={{opacity:0,y:20}} animate={{opacity:1, y:0}} transition={{duration:0.5}} className="bg-white rounded-2xl shadow-2xl px-8 py-12 max-w-xl w-full text-center ">
            ...
            <h1 className="text-3xl font-bold text-gray-600 mb-4">Order Confirmed</h1>
            <div className="space-y-4 mb-8 text-left" >
                <p className="text-gray-700">Thank you for your purchase. We are processing your order and will ship it soon. A confirmation email with your order details will be sent to your inbox shortly. </p>
                <p className="text-gray-700">Order Number: <span className="text-darkBackground font-semibold">{orderNumber}</span> </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                ...
                <Link href={"/orders"}  className="flex items-center justify-center px-4 py-3 font-semibold border border-darkBackground/90 text-darkBackground rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-md ">
