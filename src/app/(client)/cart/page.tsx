                  ...
                  <div className="border rounded-md">
                    {cartProducts.map(({ product }) => {
                      ...
                      return (
                        <div
                          key={product._id}
                          className="border p-2.5  last:border-b-0 flex items-center justify-center"
                        >
                    ...
                    <Button
                      ...
                      className="m-5 font-semibold bg-red-600 text-white hover:bg-red-700 hoverEffect "
                      variant="destructive"
                    >
                      Reset Cart
                    </Button>
                  ...
                  <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                    ...
                    <div className="space-y-4">
                      ...
                      <Button
                        ...
                        className="w-full rounded-full font-semibold tracking-wide bg-darkBackground/90 hover:bg-darkBackground text-textColor2"
                        size="lg"
                      >
                        Proceed to Checkout
                      </Button>
                      <Link
                        href=""
                        className="flex items-center justify-center py-2 border border-darkBackground/50 rounded-full border-textColor2  hover:bg-darkBackground hoverEffect"
                      >
                        <Image
                          src="/Images/paymentlogo.png"
                          alt=""
                          width={100}
                          height={100}
                        />
